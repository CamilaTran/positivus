...
const ArrowIcon = ({ color = "black", className }: ArrowIconProps) => {
    return (
        <svg width="21" height="20" viewBox="0 0 21 20" className={className} fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            <path
